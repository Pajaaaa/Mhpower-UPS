...
IoT monitoring zálohovaných zdrojů **MHpower MPU** (300–5000 W) používaných v síti družstva. Tyto zdroje nemají žádné management rozhraní — jediný výstup je lokální LED displej. Zařízení je postaveno na ESP32, které **pasivně odposlouchává sběrnici displeje (řadič TM1640)**, z rámců dekóduje vstupní/výstupní napětí, stav sítě/baterie, zátěž a alarmy, a publikuje je přes **webové rozhraní** a **SNMP v1**. Do zdroje se nijak nezasahuje — jen se „čte přes rameno" jeho vlastní displej.

Řešení je určeno pro dohled záložního napájení na odlehlých lokalitách, kam se technik dostane jen obtížně a kde dosud o stavu zdroje není žádný přehled. Stav jednotek se centrálně sbírá do power monitoru družstva (power.hkfree.org), včetně trvalého logu událostí (výpadky sítě, poruchy, restarty).

## Cíl projektu

Trvalý dohled nad záložními zdroji MHpower na odlehlých lokalitách bez zásahu do zařízení: včasná informace o výpadku napájení, stavu a zdraví baterie, přetížení a poruchách — místo zjištění „až když lokalita spadne". Součástí je odhad zbývající výdrže baterie (Peukertův model + učení z reálného provozu), a to i proaktivně na síti („kdyby teď vypadl proud").
...
4. **Nasazení na testovací lokality** — pilotní provoz na vybraných odlehlých lokalitách; kde chybí ethernet, bude doplněna WiFi brána MikroTik mAP lite s dst-nat
...
| Etapa 4 — nasazení na testovací lokality | ~20 čh |
...
**Infrastruktura:**
- Vnitřní síť družstva (SNMP polling z power monitoru)
...
| **Hardware celkem (testovací nasazení, 5 jednotek + 1× mAP)** | **~1 950 Kč** |
...
| mAP brány | Firewall: správa jen z vnitřní sítě družstva, WAN input drop, vypnuté nepoužívané služby |
| Expozice | Jednotky pouze v interní síti družstva, nejsou vystavené do internetu |
...
| Etapa 4 — testovací nasazení | 💡 Plánováno | Pilotní provoz na vybraných odlehlých lokalitách |
